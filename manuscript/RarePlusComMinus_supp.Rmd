...
I simulate `r nsim` random assembledges, slightly more than the `r sum(!is.na(commStats$pos.wm))` observed assemledges because some simulated assembledges will be rejected based on the data standards used. In Figure 1 of the main text I plot these simulated results alongside the results from the real data.
...
```{r ssad_perm_comp, dependson = c('threading', 'sim_simple_setup')}
nsite <- 30
nspp <- 50
nsim <- 100
