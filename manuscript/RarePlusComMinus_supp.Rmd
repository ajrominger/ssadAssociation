...
The results of this study can be fully reproduced by installing the package *RarePlusComMinus* (available on GitHub) written in R [@rcore].  Installation requires the package *devtools* [@devtools]:
...
Two additional custom packages are required, *socorro* [@socorro] for plotting, and *pika* [@pika] for simulating and analyzing species abundance distributions (SAD):
